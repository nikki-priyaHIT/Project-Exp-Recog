...
2. Clone the repository using `git clone https://github.com/YOUR-USERNAME/Expressions-Recognition`  - Downloads all repo files to your machine.
3. `cd Expressions-Recognition`  - Takes you to the root directory of the project.
